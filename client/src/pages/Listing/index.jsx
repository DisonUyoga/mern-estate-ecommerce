  ...
  return <Helmet title="Listing">
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <button className="bg-slate-700 rounded-lg p-3 text-white uppercase hover:opacity-95 disabled:opacity-85" disabled={loading || uploading}>{loading?"creating..." : "create listing"}</button>
